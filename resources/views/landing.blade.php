...
<head>
    ...
    <title>Kehadiran Ujian Nasional</title>
    ...
    <!-- Perfect Scrollbar -->
    <link type="text/css" href="{{asset('FronEnd/vendor/perfect-scrollbar.css')}}" rel="stylesheet">

    <!-- App CSS -->
    <link type="text/css" href="{{asset('FronEnd/css/app.css')}}" rel="stylesheet">
    <link type="text/css" href="{{asset('FronEnd/css/app.rtl.css')}}" rel="stylesheet">

    <!-- Material Design Icons -->
    <link type="text/css" href="{{asset('FronEnd/css/vendor-material-icons.css')}}" rel="stylesheet">
    <link type="text/css" href="{{asset('FronEnd/css/vendor-material-icons.rtl.css')}}" rel="stylesheet">

    <!-- Font Awesome FREE Icons -->
    <link type="text/css" href="{{asset('FronEnd/css/vendor-fontawesome-free.css')}}" rel="stylesheet">
    <link type="text/css" href="{{asset('FronEnd/css/vendor-fontawesome-free.rtl.css')}}" rel="stylesheet">

    <!-- ion Range Slider -->
    <link type="text/css" href="{{asset('FronEnd/css/vendor-ion-rangeslider.css')}}" rel="stylesheet">
    <link type="text/css" href="{{asset('FronEnd/css/vendor-ion-rangeslider.rtl.css')}}" rel="stylesheet">
...
<body class="layout-fixed layout-sticky-subnav">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input id="email" type="email" class="form-control form-control-prepended @error('email') is-invalid @enderror" name="email" placeholder="Masukkan Email" autofocus>
                                            @error('email')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input id="password_2" type="password" required="" class="form-control form-control-prepended @error('password') is-invalid @enderror" name="password" placeholder="Masukkan Password" required>
                                            @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="col">
                                ...
                                <div class="avatar-group mt-2">
                                    ...
                                    <div class="avatar avatar-xs">
                                        <img src="{{asset('FronEnd/images/256_joao-silas-636453-unsplash.jpg')}}" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>

                                    <div class="avatar avatar-xs">
                                        <img src="{{asset('FronEnd/images/256_jeremy-banks-798787-unsplash.jpg')}}" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>

                                    <div class="avatar avatar-xs">
                                        <img src="{{asset('FronEnd/images/256_daniel-gaffey-1060698-unsplash.jpg')}}" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="avatar-group mt-2">
                                    ...
                                    <div class="avatar avatar-xs">
                                        <img src="{{asset('FronEnd/images/256_rsz_1andy-lee-642320-unsplash.jpg')}}" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>

                                    <div class="avatar avatar-xs">
                                        <img src="{{asset('FronEnd/images/256_michael-dam-258165-unsplash.jpg')}}" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>

                                    <div class="avatar avatar-xs">
                                        <img src="{{asset('FronEnd/images/256_luke-porter-261779-unsplash.jpg')}}" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>

                                    <div class="avatar avatar-xs">
                                        <img src="{{asset('FronEnd/images/stories/256_rsz_clem-onojeghuo-193397-unsplash.jpg')}}" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>
    ...
    <!-- App Settings FAB -->
    <!-- jQuery -->
    <script src="{{asset('FronEnd/vendor/jquery.min.js')}}"></script>

    <!-- Bootstrap -->
    <script src="{{asset('FronEnd/vendor/popper.min.js')}}"></script>
    <script src="{{asset('FronEnd/vendor/bootstrap.min.js')}}"></script>

    <!-- Perfect Scrollbar -->
    <script src="{{asset('FronEnd/vendor/perfect-scrollbar.min.js')}}"></script>

    <!-- DOM Factory -->
    <script src="{{asset('FronEnd/vendor/dom-factory.js')}}"></script>

    <!-- MDK -->
    <script src="{{asset('FronEnd/vendor/material-design-kit.js')}}"></script>

    <!-- Range Slider -->
    <script src="{{asset('FronEnd/vendor/ion.rangeSlider.min.js')}}"></script>
    <script src="{{asset('FronEnd/js/ion-rangeslider.js')}}"></script>

    <!-- App -->
    <script src="{{asset('FronEnd/js/toggle-check-all.js')}}"></script>
    <script src="{{asset('FronEnd/js/check-selected-row.js')}}"></script>
    <script src="{{asset('FronEnd/js/dropdown.js')}}"></script>
    <script src="{{asset('FronEnd/js/sidebar-mini.js')}}"></script>
    <script src="{{asset('FronEnd/js/app.js')}}"></script>

    <!-- App Settings (safe to remove) -->
    <script src="{{asset('FronEnd/js/app-settings.js')}}"></script>


    <!-- List.js -->
    <script src="{{asset('FronEnd/vendor/list.min.js')}}"></script>
    <script src="{{asset('FronEnd/js/list.js')}}"></script>
